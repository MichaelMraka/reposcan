...
if __name__ == '__main__':
    ...
    print(repo.get_update_count(type="security"))
    print(repo.get_update_count(type="bugfix"))
    print(repo.get_update_count(type="enhancement"))
    print(repo.get_update_count(type="newpackage"))
